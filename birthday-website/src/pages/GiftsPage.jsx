        ...
        >
          {gifts.map((gift) => {
            ...
            return (
              <motion.div
                key={gift.id}
                className={`gift-card ${isOpen ? 'opened' : ''}`}
                variants={{
              ...
              >
                <AnimatePresence mode="wait">
                  {!isOpen ? (
                    ...
                    >
                      <div className="gift-ribbon-h" style={{ background: gift.ribbon }} />
                      <div className="gift-ribbon-v" style={{ background: gift.ribbon }} />
                      <div className="gift-bow" style={{ borderColor: gift.ribbon }}>
                        <span className="bow-loop bow-left" style={{ borderColor: gift.ribbon }} />
                        <span className="bow-loop bow-right" style={{ borderColor: gift.ribbon }} />
                        <span className="bow-center" style={{ background: gift.ribbon }} />
                      </div>
                      <span className="gift-box-emoji">{gift.emoji}</span>
                    ...
                    >
                      <span className="gift-msg-emoji">{gift.emoji}</span>
                      <h3 className="gift-msg-title">{gift.title}</h3>
                      <p className="gift-msg-text">{gift.message}</p>
                    </motion.div>
                  )}
                </AnimatePresence>
              </motion.div>
